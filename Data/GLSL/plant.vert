...
{	
	...
	vec3 normal = normalize(gl_Normal)+vertex_offset.xyz*10.0;
	vec3 temp_tangent = normalize(gl_MultiTexCoord1.xyz)+vertex_offset.yzx*10.0;
	vec3 bitangent = normalize(gl_MultiTexCoord2.xyz)+vertex_offset.zxy*10.0;
