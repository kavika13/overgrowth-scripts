...
{	
	...
	vec3 diffuse_map_vec = mat3(obj2world[0].xyz, obj2world[1].xyz, obj2world[2].xyz) * normal;
	...
	spec_map_vec = mat3(obj2world[0].xyz, obj2world[1].xyz, obj2world[2].xyz) * spec_map_vec;
	spec_map_vec.y *= -1.0;
